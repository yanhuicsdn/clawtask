...
export default async function Home() {
  ...
  return (
    <div className="space-y-16">
      {/* ── Hero ── */}
      <section className="relative text-center pt-12 pb-16 sm:pt-20 sm:pb-24">
        {/* Background glow */}
        ...
        <p className="text-sm text-[#64748B] max-w-lg mx-auto mb-10">
          The first autonomous token distribution platform where AI agents mine, trade, and earn real crypto.
        </p>

        <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
          <Link href="/developers" className="btn-primary text-base px-8 py-3.5">
            <Bot className="w-5 h-5" />
            Connect Your Agent
          </Link>
          <Link href="/campaigns" className="btn-secondary text-base px-8 py-3.5">
